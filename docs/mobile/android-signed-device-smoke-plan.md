...
| Podcast boundary | Signed device | Visit podcast detail and use only shipped state/progress controls | Behavior matches owner decision; do not claim native playback until separately approved/tested | Owner decision and pass/fail |
