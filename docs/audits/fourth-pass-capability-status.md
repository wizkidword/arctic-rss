...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Terminal feed and podcast refresh jobs release their deterministic source IDs | Baseline finding confirmed; remediation not started | Existing mocked queue-option tests only | Not applicable | Real local Redis reproduction confirms retained failed job blocks re-enqueue | No | No | No | Review and approve a future release | 2026-08-08 |
| Durable Redis heartbeat and maintenance recovery | Baseline finding confirmed; reconnecting control plane not implemented | Existing unit coverage does not restart Redis | Not applicable | Restart fault injection pending Phase 2 | No | No | No | Review and approve a future release | 2026-08-08 |
