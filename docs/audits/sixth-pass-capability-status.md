...
| MOB-OFFLINE-001 | IN_PROGRESS | Phase 4 source adds mandatory SQLite user/device owner metadata and purges unowned or switched-account data before sync. Authenticated route grouping, backup exclusion proof, corrupt-row recovery, and full restore/account-switch tests remain open. |
