...
export const feedDirectoryCategories: readonly FeedDirectoryCategory[] = [
  ...
  {
    description: "Film, television, music, celebrity, and culture coverage.",
    id: "entertainment",
    label: "Entertainment",
  },
  {
  ...
  {
    description:
      "Boxing news, fight previews, results, rankings, and analysis.",
    id: "boxing",
    label: "Boxing",
  },
  {
  ...
  {
    description:
      "Golf news, tours, equipment, instruction, majors, and player coverage.",
    id: "golf",
    label: "Golf",
  },
]
