    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className="sm:max-w-md">
        <SheetHeader>
          ...
          <SheetDescription>
            Subscribe with an RSS/Atom URL, website URL, or YouTube channel URL.
          </SheetDescription>
        </SheetHeader>
        ...
        <form ref={formRef} action={formAction} className="flex flex-col gap-4 px-4">
          <FieldGroup>
            <Field>
              ...
              />
              <FieldDescription>
                YouTube channel pages become RSS feeds automatically. Local and private network addresses are blocked.
              </FieldDescription>
            </Field>
            {folders.length > 0 && (
              <Field>
